-- Migration: Create Contacts System
...
-- First, rename existing clients table if it exists
...
-- Drop indexes
DROP INDEX IF EXISTS idx_contact_escrows_role;
DROP INDEX IF EXISTS idx_contact_escrows_contact_id;
DROP INDEX IF EXISTS idx_contact_escrows_escrow_id;
DROP INDEX IF EXISTS idx_clients_status;
DROP INDEX IF EXISTS idx_clients_assigned_agent;
DROP INDEX IF EXISTS idx_clients_contact_id;
DROP INDEX IF EXISTS idx_agents_license_number;
DROP INDEX IF EXISTS idx_agents_contact_id;
DROP INDEX IF EXISTS idx_contacts_type;
DROP INDEX IF EXISTS idx_contacts_team_id;
DROP INDEX IF EXISTS idx_contacts_full_name;
DROP INDEX IF EXISTS idx_contacts_phone;
DROP INDEX IF EXISTS idx_contacts_email;

-- Drop junction tables
DROP TABLE IF EXISTS contact_escrows;
DROP TABLE IF EXISTS contact_clients;
DROP TABLE IF EXISTS contact_agents;
...
ALTER TABLE IF EXISTS escrow_buyers_old RENAME TO escrow_buyers;
ALTER TABLE IF EXISTS escrow_sellers_old RENAME TO escrow_sellers;

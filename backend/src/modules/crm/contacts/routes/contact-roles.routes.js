...
router.post('/', requireRole('system_admin', 'broker'), contactRolesController.create);        // POST /v1/contact-roles - Create new role (admin only)
router.put('/:id', requireRole('system_admin', 'broker'), contactRolesController.update);      // PUT /v1/contact-roles/:id - Update role (admin only)

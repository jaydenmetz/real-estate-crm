...
class AppointmentMock {
  ...
  static async findAll(filters = {}) {
    try {
      ...
      if (filters.propertyId) {
        filtered = filtered.filter((a) => a.locationDetails?.propertyId === filters.propertyId);
      }
  ...
  static async getStats() {
    ...
    const thisMonth = mockAppointments.filter((a) => a.startTime >= startOfMonth && a.startTime <= endOfMonth);

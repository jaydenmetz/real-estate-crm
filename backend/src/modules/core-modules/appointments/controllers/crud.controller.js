 ...
 * - getAppointments: List appointments with filters and pagination
 * - getAppointment: Get single appointment by ID
 * - createAppointment: Create new appointment
 * - updateAppointment: Update existing appointment
 * - archiveAppointment: Soft delete (archive) appointment
 * - deleteAppointment: Hard delete archived appointment
 * - batchDeleteAppointments: Delete multiple archived appointments
 *

...
class ClientMock {
  ...
  static find(filters = {}) {
    const query = {
      ...
      exec() {
        return ClientMock.findAll(this.filters, this.sortOptions, this.limitValue, this.skipValue);
      },
  ...
  static async findAll(filters = {}, sortOptions = {}, limitValue = null, skipValue = 0) {
    try {

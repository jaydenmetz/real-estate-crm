...
const escrowValidationRules = () => {
  return [
    ...
    body('escrow_number').optional().trim().escape().isLength({ max: 50 }),
...
const clientValidationRules = () => {
  return [
    ...
    body('address').optional().trim().escape().isLength({ max: 255 }),
    body('city').optional().trim().escape().isLength({ max: 100 }),
    body('state').optional().trim().escape().isLength({ max: 2 }),
...
const leadValidationRules = () => {
  return [
    ...
    body('notes').optional().trim().escape().isLength({ max: 5000 })
  ];
};

...
const StatCard = memo(({ icon: Icon, title, value, prefix = '', suffix = '', color, delay = 0, trend, showPrivacy = false, goal }) => {
...
// Main component for the stats cards grid
const EscrowStatsCards = ({
  selectedStatus,
  stats,
  escrows,
  archivedCount,
  ...
  return (
    <Grid container spacing={2}>
      {renderStatsForStatus()}
    </Grid>
  );
};

export default EscrowStatsCards;
 ...
 * LeadScopeFilter.jsx
 *
 * Scope filter configuration for leads dashboard.
 * Returns role-based filter options (user/team/broker views).
 *
 * Usage: Imported into leads.config.js
 */

export const getLeadScopeOptions = (user) => {
...
export const leadDefaultScope = 'user';

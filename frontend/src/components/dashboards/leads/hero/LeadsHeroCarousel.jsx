...
/**
 * LeadsHeroCarousel - Wraps the entire hero section in a carousel
 *
 * Pages:
 * - Page 1: Standard hero with 4 stats + AI Manager widget + buttons
 * - Page 2: AI Lead Nurturing Manager focused view
 *
 * Features:
...
const LeadsHeroCarousel = ({
  ...
  const totalPages = 2; // Standard hero + AI Lead Manager page
        ...
        <AnimatePresence initial={false} mode="wait" custom={direction}>
          ...
          {currentPage === 1 && (
            <motion.div
              ...
              transition={{ duration: 0.3, ease: 'easeInOut' }}
            >
              {/* Page 2: AI Lead Nurturing Manager view */}
              <AIManagerPage
...
export default LeadsHeroCarousel;

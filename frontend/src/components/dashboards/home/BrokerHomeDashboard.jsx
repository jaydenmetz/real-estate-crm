 ...
 * BrokerHomeDashboard
 *
 * Home dashboard for broker role showing brokerage-wide statistics
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        ...
        const response = await apiInstance.get(`/stats/broker?${params.toString()}`);
      ...
      <Container maxWidth="xl">
        <Box mb={3}>
          <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
            ...
            <Chip label="BROKER" color="primary" sx={{ fontWeight: 'bold' }} />
          </Stack>

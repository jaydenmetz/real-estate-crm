...
const HeroSection = styled(Box)(({ theme }) => ({
  ...
  boxShadow: '0 20px 60px rgba(123, 31, 162, 0.3)',
...
const TeamHeroCard = ({ stats, loading }) => {
  if (loading) {
    return (
      <HeroSection>
    ...
    <HeroSection>
      ...
      >
        <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
          <GroupIcon sx={{ mr: 1.5, fontSize: 32 }} />
          <Typography variant="h4" sx={{ fontWeight: 700 }}>
            {stats.teamName || 'Team Dashboard'}
          </Typography>
        </Box>
        <Typography variant="body1" sx={{ opacity: 0.9, mb: 3 }}>
          {stats.teamMemberCount || 0} team members • Team performance metrics
        </Typography>
      </motion.div>

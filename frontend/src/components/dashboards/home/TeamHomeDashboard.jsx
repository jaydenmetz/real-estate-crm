 ...
 * TeamHomeDashboard
 *
 * Home dashboard for team_owner role showing team-wide statistics
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        ...
        const response = await apiInstance.get(`/stats/team?${params.toString()}`);
      ...
      <Container maxWidth="xl">
        <Box mb={3}>
          <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
            ...
            <Chip label="TEAM OWNER" color="secondary" sx={{ fontWeight: 'bold' }} />
          </Stack>

/**
 * AppointmentNavigation.jsx - Navigation bar with tabs, view controls, and filters
 *
 * Contains:
 * - Status tabs (Active, Pending, Sold, Expired, Archived)
    ...
    <Box sx={{ mb: 4 }}>
      ...
      >
        ...
        >
          ...
          >
            <Tab label="Active Appointments" value="active" />
            <Tab label="Pending Appointments" value="pending" />
            <Tab label="Sold Appointments" value="sold" />

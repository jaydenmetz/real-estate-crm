...
export const escrowsAPI = {
  ...
  permanentDelete: (id) => apiInstance.delete(`/escrows/${id}`), // Alias for delete
...
export const listingsAPI = {
  ...
  archive: (id) => apiInstance.put(`/listings/${id}/archive`),
  restore: (id) => apiInstance.put(`/listings/${id}/restore`),
